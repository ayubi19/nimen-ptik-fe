  ...
  const loadConfig = useCallback(async (batchId) => {
    ...
    try {
      ...
      reset({
        ...
        nimen_freeze_date: data.nimen_freeze_date ? data.nimen_freeze_date.split('T')[0] : '',
  ...
  const handleSave = useCallback(async (values) => {
    ...
    try {
      const payload = {
        ...
        nimen_freeze_date: values.nimen_freeze_date || null,
                  ...
                  <Grid container spacing={4}>
                    ...
                    <Grid item xs={12} sm={4}>
                      <Controller name='start_date' control={control}
                        render={({ field }) => (
                          <TextField {...field} fullWidth label='Tanggal Mulai' type='date'
                            InputLabelProps={{ shrink: true }}
                            helperText='Tanggal awal pendidikan angkatan ini'
                          />
                        )}
                      />
                    </Grid>
                    <Grid item xs={12} sm={4}>
                      <Controller name='end_date' control={control}
                        render={({ field }) => (
                          <TextField {...field} fullWidth label='Tanggal Selesai' type='date'
                            InputLabelProps={{ shrink: true }}
                            helperText='Tanggal akhir pendidikan angkatan ini'
                          />
                        )}
                      />
                    </Grid>
                  ...
                  <Grid container spacing={4} alignItems='center'>
                    <Grid item xs={12} sm={4}>
                      <Controller name='nimen_freeze_date' control={control}
                        render={({ field }) => (
                          <TextField {...field} fullWidth label='Tanggal Freeze NIMEN' type='date'
                            InputLabelProps={{ shrink: true }}
                          />
                        )}
                      />
